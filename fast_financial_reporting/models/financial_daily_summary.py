...
class FastFinancialDailySummary(models.Model):
    ...
    _order = "date desc, account_id, analytic_account_id"
    _rec_name = "date"
    ...
    _sql_constraints = [
        ("fast_fin_daily_unique", "unique(date, company_id, account_id, analytic_key)", "A daily summary already exists for this date, company, account and analytic key."),
    ]
