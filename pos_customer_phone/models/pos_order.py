...
class PosOrder(models.Model):
    ...
    def _order_fields(self, ui_order):
        ...
        if phone:
            ...
            elif cleaned.startswith('009665'):
                cleaned = '+' + cleaned[2:]
            elif cleaned.startswith('9665'):
                cleaned = '+966' + cleaned[3:]
            elif not cleaned.startswith('+') and cleaned.startswith('5'):
                cleaned = '+966' + cleaned
            res['customer_phone'] = cleaned
        return res
