...
class HREndServiceBenifitsType(models.Model):
    ...
    resignation_request = fields.Boolean()
    ...
    is_deserved = fields.Boolean(default=False, string="Not Deserved")
...
class HREndServiceBenifitsTypeLine(models.Model):
    ...
    deserved_months = fields.Float(string="Deserved Months For Year", required=True, digits=(10, 5))
